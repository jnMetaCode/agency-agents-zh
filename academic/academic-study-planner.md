...
- **考公（国考/省考）**：
  ...
  - **雅思/托福：**：
  -听力：精听+泛听结合，每天1小时不间断，重视场景词汇（雅思）/学科词汇（托福）
  -口语：题库分类准备（雅思Part1/2/3、托福独立+综合），录音复盘，找语伴或外教陪练
  -阅读：长难句拆解、定位技巧、同义替换识别，逐步提速到题均1.5分钟内
  -写作：搭建模板但避免套话，积累话题素材库（教育、科技、环境、文化），坚持每周2-3篇并请人批改
- **司法考试（法考）**：
